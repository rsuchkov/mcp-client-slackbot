...
def upgrade() -> None:
    ...
    op.create_index('idx_user_slack_ids', 'users', ['slack_user_id', 'slack_team_id'], unique=False)
    ...
    op.create_table('user_credentials',
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('user_id', 'credential_type', 'credential_name', name='uq_user_credential')
    )
    op.create_index('idx_user_credential', 'user_credentials', ['user_id', 'credential_type'], unique=False)
    ...
    op.create_index('idx_user_server', 'user_server_configs', ['user_id', 'server_id'], unique=False)
    ...
    op.create_index('idx_conversation_lookup', 'conversations', ['user_id', 'slack_channel_id', 'slack_thread_ts'], unique=False)
    op.create_index(op.f('ix_conversations_slack_channel_id'), 'conversations', ['slack_channel_id'], unique=False)
