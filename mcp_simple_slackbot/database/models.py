...
class User(Base):
    ...
    server_configs = relationship(
        "UserServerConfig", back_populates="user", cascade="all, delete-orphan"
    )
    conversations = relationship(
        "Conversation", back_populates="user", cascade="all, delete-orphan"
    )

    __table_args__ = (Index("idx_user_slack_ids", "slack_user_id", "slack_team_id"),)
...
class MCPServer(Base):
    ...
    user_configs = relationship(
        "UserServerConfig", back_populates="server", cascade="all, delete-orphan"
    )
...
class Conversation(Base):
    ...
    __table_args__ = (
        Index(
            "idx_conversation_lookup", "user_id", "slack_channel_id", "slack_thread_ts"
        ),
    )
